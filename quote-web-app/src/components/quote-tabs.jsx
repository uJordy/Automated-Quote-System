  ...
  const tabs = [
    {
      ...
      value: "summary",
      content: (
        <div className="flex flex-col w-full overflow-hidden relative h-full rounded-2xl p-10 text-white bg-gradient-to-br from-purple-700 to-violet-900">
          ...
          <div className="my-5 inline-flex mt-auto">
    ...
    },
    {
      ...
      value: "technical",
      content: (
        <div className="flex flex-col w-full overflow-hidden relative h-full rounded-2xl p-10 text-white bg-gradient-to-br from-stone-700 to-stone-900">
